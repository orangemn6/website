...
Everyone is always asking me, how do I rice linux so fast? And The answer is, I just have the some bash scripts set to keybinds. For the i3 window manager.

### Script 1: Pywal

So for this one you need pywal.

```bash
wal -i $HOME/Pictures/wallpapers -o wal-set
```

### Script 2: Sublime text theme
...
### Script 3: Put it all together

Put these scripts in /usr/local/bin

Make one last shell script called theme
